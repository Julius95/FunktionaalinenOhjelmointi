...
(defn -main
  ...
  (println (take 6 tri))
  (println (last (take 6 tri)))
  (prompt-rows))

;T.2 Luontifunktion luoma tietorakenne
...
;T.3
;(def tri (tri*)) Kutsuu tri* funktiota ja liittää ko. funktion palauttaman lazy-seqin tri-muuttujaan 
;(take 6 tri)
;=> (1 3 6 10 15 21)
;Ottaa kuusi ensimmäistä triangeli lukua 

;(last (take 6 tri))
;=> 21
;Ottaa viimeisen kuuden triangeli luvun joukosta
